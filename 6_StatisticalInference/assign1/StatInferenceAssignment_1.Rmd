...
The actual(empirical) distribution is centered at **`r emp_mean`** compared to the theoretical center ie. **`r TMean`**

### 2. Show how variable it is and compare it to the theoretical variance of the distribution.
The actual(empirical) variance is **`r emp_var`** compared to the theoretical variance ie. **`r TVar`**

Actual(empirical) standard deviation is **`r emp_sd`** compared to the theoretical std deviation ie. **`r TStdDev`**
...
|:-------------------:|:-----------------:|:---------------:|
|**Mean**                 |**`r TMean`**          |**`r emp_mean`**     |
|**Standard Deviation**   |**`r TStdDev`**        |**`r emp_sd`**       |
|**Variance**             |**`r TVar`**           |**`r emp_var`**      |
